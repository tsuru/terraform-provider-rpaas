...
require (
	...
	github.com/tsuru/rpaas-operator v0.45.0
...
require (
	...
	github.com/kedacore/keda/v2 v2.10.1 // indirect
	...
	sigs.k8s.io/go-open-service-broker-client/v2 v2.0.0-20200925085050-ae25e62aaf10 // indirect
